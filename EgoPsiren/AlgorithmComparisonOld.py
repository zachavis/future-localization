...
#        # KNN DATA LOADING
#    knnPickle = open('knn_alexfeats_aligned.knn','rb')
#    KNN = pickle.load(knnPickle)
#    knnPickle.close()

#    dictPickle = open('knn_traintraj_aligned.dict','rb')
...
#    # Load Networks
#    network = torch.load('overfit_imploc_grad_192_miniset.pt') #torch.load('hypernet_1200imgs_300epochs.pt') #overfit_test_network_exp_newnewloss
#    vae_network = torch.load('overfit_VAE_192_imageprior.pt') #''overfit_test_network_exp_AE.pt
...
#    #for key in RESIZED_IMAGE_DICTIONARY_TR.keys():